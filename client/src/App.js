    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route exact path="/hikes/wintergearlist" component={WinterGearList} />
          <Route exact path="/hikes/desertgearlist" component={DesertGearList} />
          {/* My Gear Inventory */}
          <Route exact path="/mygear" component={MyGear} />
          {/* Build a Pack */}
          <Route exact path="/buildapack" component={BuildAPack} />
          <Route exact path="/buildapack/:category" component={Essentials}/>
        </div>
      </Router>
    );
  }
